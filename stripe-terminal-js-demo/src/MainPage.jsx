...
class App extends Component {
    ...
    if (!this.pendingPaymentIntentSecret) {
      try {
        ...
        let createIntentResponse = await this.client.createPaymentIntent({
          ...
          paymentMethodTypes,
          connectAccountId: this.state.connectAccountId,
        });
  ...
  updateConnectAccountId = connectAccountId => {
    console.log('connectAccountId', connectAccountId)
    console.log('this.state', this.state);
    this.setState({ connectAccountId });
    console.log('this.state', this.state);
  }
      ...
      return (
        <>
          <CommonWorkflows
            ...
            connectAccountId={this.state.connectAccountId}
            onChangeConnectAccountId={this.updateConnectAccountId}
          />
          <RefundForm
